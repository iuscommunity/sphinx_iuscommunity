...
.. toctree::
    ...
    IUSClientUsageGuide.rst
    UpgradingTheOldWay.rst
    TheSafeRepoInitiative.rst


Developer Documentation
=======================

* :ref:`IUSDeveloperGuide`
    * :ref:`Managing_Updates`

.. toctree::
    :maxdepth: 1
    
    ContributingToIUS.rst
    ConfiguringADedicatedRPMDevelopmentBox.rst
    SettingUpAnOfficialIUSMirror.rst
